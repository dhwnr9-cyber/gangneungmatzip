...
PLACES = [
    ...
    {"name": "강릉물회 강릉횟집 천둥수산 강문해변점", "query": "천둥수산 강릉 초당동"},
    {"name": "강릉 카페 체크이스트",  "query": "체크이스트 강릉 카페"},
    {"name": "강릉빵다방",           "query": "강릉빵다방"},
    {"name": "봉봉방앗간",           "query": "봉봉방앗간 강릉"},
    {"name": "오버웨잇 강릉본점",    "query": "오버웨잇 강릉 에그타르트"},
    {"name": "베이커리 가루",        "query": "베이커리 가루 강릉 교동"},
    {"name": "레드망치",             "query": "레드망치 강릉"},
    {"name": "메종고니",             "query": "메종고니 강릉 초당동"},
    {"name": "안뇬소품샵",           "query": "안뇬소품샵 강릉"},
]
